...
public class ComparePage_eight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compare_page_eight);
    ...
    int isOpen;
    int[] buttons = {R.id.comp8_b1_1, R.id.comp8_b2_1, R.id.comp8_b3_1, R.id.comp8_b4_1, R.id.comp8_b5_1, R.id.comp8_b6_1, R.id.comp8_b1_2, R.id.comp8_b2_2, R.id.comp8_b3_2, R.id.comp8_b4_2, R.id.comp8_b5_2, R.id.comp8_b6_2};
