...
public class ComparePage_five extends AppCompatActivity {

    Button b;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_compare_page_five);
        setRequestedOrientation(SCREEN_ORIENTATION_LANDSCAPE);

        ADDS add = new ADDS(this);
        add.addNonSkipVideo(this);

        if (Character.compareLevel[4]==1){
            next();
        }
    ...
    int isOpen;
    int[] buttons = {R.id.comp5_b1_1, R.id.comp5_b2_1, R.id.comp5_b3_1, R.id.comp5_b4_1, R.id.comp5_b5_1, R.id.comp5_b6_1, R.id.comp5_b1_2, R.id.comp5_b2_2, R.id.comp5_b3_2, R.id.comp5_b4_2, R.id.comp5_b5_2, R.id.comp5_b6_2};
    ...
    public void next(View view){
        Intent intent = new Intent(this, ComparePage_six.class);
        Character.compareLevel[4] = 1;
        startActivity(intent);
        finish();
    }
