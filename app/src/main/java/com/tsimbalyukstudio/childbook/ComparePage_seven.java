...
public class ComparePage_seven extends AppCompatActivity {

    Button b;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_compare_page_seven);
        setRequestedOrientation(SCREEN_ORIENTATION_LANDSCAPE);

        ADDS add = new ADDS(this);
        add.addNonSkipVideo(this);

        if (Character.compareLevel[6]==1){
            next();
        }
    ...
    int isOpen;
    int[] buttons = {R.id.comp7_b1_1, R.id.comp7_b2_1, R.id.comp7_b3_1, R.id.comp7_b4_1, R.id.comp7_b5_1, R.id.comp7_b6_1, R.id.comp7_b1_2, R.id.comp7_b2_2, R.id.comp7_b3_2, R.id.comp7_b4_2, R.id.comp7_b5_2, R.id.comp7_b6_2};
    ...
    public void count(View view) {
        ...
        for (int x = 0; x < buttons.length; x++) {
            if (buttons[x] == temp && isCheckedButtons[x] != true) {
                isOpen++;
    ...
    public void next(View view){
        Intent intent = new Intent(this, ComparePage_eight.class);
        Character.compareLevel[6] = 1;
        startActivity(intent);
        finish();
    }
