...
public class ComparePage_three extends AppCompatActivity {

        Button b;
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_compare_page_three);
            setRequestedOrientation(SCREEN_ORIENTATION_LANDSCAPE);

            ADDS add = new ADDS(this);
            add.addNonSkipVideo(this);

            if (Character.compareLevel[2]==1){
                next();
            }
        ...
        int isOpen;
        int[] buttons = {R.id.comp3_b1_1, R.id.comp3_b2_1, R.id.comp3_b3_1, R.id.comp3_b4_1, R.id.comp3_b5_1, R.id.comp3_b6_1, R.id.comp3_b1_2, R.id.comp3_b2_2, R.id.comp3_b3_2, R.id.comp3_b4_2, R.id.comp3_b5_2, R.id.comp3_b6_2};
        ...
        public void next(View view){
            Intent intent = new Intent(this, ComparePage_fore.class);
            Character.compareLevel[2] = 1;
            startActivity(intent);
            finish();
        }
