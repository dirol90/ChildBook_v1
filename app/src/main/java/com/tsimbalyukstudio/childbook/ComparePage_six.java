...
public class ComparePage_six extends AppCompatActivity {

    Button b;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_compare_page_six);
        setRequestedOrientation(SCREEN_ORIENTATION_LANDSCAPE);

        ADDS add = new ADDS(this);
        add.addNonSkipVideo(this);

        if (Character.compareLevel[5]==1){
            next();
        }
    ...
    int isOpen;
    int[] buttons = {R.id.comp6_b1_1, R.id.comp6_b2_1, R.id.comp6_b3_1, R.id.comp6_b4_1, R.id.comp6_b5_1, R.id.comp6_b6_1, R.id.comp6_b1_2, R.id.comp6_b2_2, R.id.comp6_b3_2, R.id.comp6_b4_2, R.id.comp6_b5_2, R.id.comp6_b6_2};
    ...
    public void next(View view){
        Intent intent = new Intent(this, ComparePage_seven.class);
        Character.compareLevel[5] = 1;
        startActivity(intent);
        finish();
    }
